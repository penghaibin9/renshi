...
def verify_first_password(browser, *, base, data, record, out, require):
    ...
    try:
        ...
        invalid = submit("incorrect-initial-password", desired, desired)
        require(invalid is not None and invalid.status == 400, "Incorrect current password was accepted")
        ...
        success = submit(current, desired, desired)
