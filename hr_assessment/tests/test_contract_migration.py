...
class MigrationTest(TestCase):
    def test_migration_has_operations(self):
        from hr_assessment.migrations import 0001_initial as m
        self.assertGreater(len(m.Migration.operations), 0)
...
class ReconciliationTest(TestCase):
    ...
    def test_application_ledger_tracks_version(self):
        from hr_assessment.models.result import HrResultApplicationLedger, HrFinalAssessmentResult
        import uuid
        ...
        ledger = HrResultApplicationLedger.objects.create(
            tenant_id=10001, result=result, consumer_domain="hr_contracts",
            consumer_object_id=uuid.uuid4(), purpose="REFERENCE", result_version=1,
        )
...
class AuditTest(TestCase):
    ...
    def test_assessment_event_types_complete(self):
        ...
        required = {"AssessmentResultFinalized", "AssessmentResultRevised",
                     "TermAssessmentFinalized", "AssessmentPolicyPublished"}
