...
urlpatterns = [
    ...
    path(
        "<uuid:staff_id>/backgrounds-page",
        views.background_facts,
        name="hr03-staff-backgrounds",
    ),
    path(
        "<uuid:staff_id>/materials-page",
        views.materials,
        name="hr03-staff-materials",
    ),
    path(
        "<uuid:staff_id>/corrections-page",
        views.corrections,
        name="hr03-staff-corrections",
    ),
]
