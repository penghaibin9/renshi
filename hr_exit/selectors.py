...
def dashboard_snapshot(tenant_id: int) -> dict:
    ...
    return {
        ...
        "recentCases": list(cases.order_by("-updated_at")[:8].values(
        ...
        "capabilities": {
            "exitCase": True, "effectSaga": True, "exitFact": True, "retirementFact": True,
            "approvalWorkflow": False, "handoverChecklist": False, "retirementPolicy": False,
            "retirementPrecheck": False, "assetProvider": False, "iamProvider": False,
            "financeProvider": False, "archiveProvider": False,
        },
    }
