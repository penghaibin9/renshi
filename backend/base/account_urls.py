...
from base import account_invitation, account_password, account_views
...
urlpatterns = [
    ...
    path(
        ...
        account_invitation.account_invitation_complete,
        name="account-invitation-complete",
    ),
    path("notifications/", account_views.notifications, name="notifications"),
    path(
        "all-notifications/",
        account_views.all_notifications,
        name="all-notifications",
    ),
    path(
        "get-horilla-installed-apps/",
        account_views.get_horilla_installed_apps,
