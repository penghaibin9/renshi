...
EVENT_DEFINITIONS = (
    ...
    BusinessEventDefinition("hr.assessment.assessment_evaluation.submitted", "HR12", "assessment_evaluation", description="Assigned reviewer submitted a scored evaluation"),
    BusinessEventDefinition("hr.assessment.assessment_decision.completed", "HR12", "assessment_decision", description="Collective assessment decision session completed"),
    ...
    BusinessEventDefinition("hr.assessment.assessment_result.notified", "HR12", "assessment_result", description="Formal assessment result delivered with receipt"),
    BusinessEventDefinition("hr.assessment.assessment_result.acknowledged", "HR12", "assessment_result", description="Formal assessment result acknowledged by employee"),
    BusinessEventDefinition("hr.assessment.assessment_result.archived", "HR12", "assessment_result", description="Formal assessment result archive package sealed"),
