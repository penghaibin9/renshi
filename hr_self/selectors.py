...
def dashboard_snapshot(context) -> dict:
    ...
    return {
        ...
        "services": services,
        "capabilities": {
            "selfIdentity": True, "serviceCatalog": True, "pinnedServices": True, "home": True,
            "hr03To16Providers": False, "todos": False, "progress": False, "files": False,
            "payslipContractAggregation": False, "mobileHighFrequency": True, "idorGuard": True,
        },
    }
